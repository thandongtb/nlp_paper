...
\title{Deep learning ASR-based for non-native learner mispronunciation detection}
...
\begin{IEEEkeywords}
Pronunciation Detection, Phonetic Classification, Speech Recognition, Deep Learning Speech
\end{IEEEkeywords}
...
The research result was applied in \textbf{Chatty Pheasant Applicaiton} - a service to help non-native learner improve their Japanese pronunciation of \textbf{\textit{Framgia Inc}}\footnote{\url{www.recruit.framgia.vn}}
